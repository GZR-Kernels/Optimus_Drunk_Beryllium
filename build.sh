...
KERNEL_DIR=$PWD
CLANG_TOOLCHAIN=$ANDROIDDIR/kernel/prebuilts/clang-6189010/bin/clang-10
...
FINAL_KERNEL_ZIP=Optimus_Drunk_Beryllium_v10.8.zip
...
export KBUILD_COMPILER_STRING="Clang Version 10.0.3"
